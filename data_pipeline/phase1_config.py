...
CONFIG = {
    ...
    # "sllm_model": "Qwen/Qwen3-VL-8B-Instruct",   # ollama list 로 확인 후 변경
    # "sllm_model": "llama3.1:8b",   # ollama list 로 확인 후 변경
    "sllm_model": "qwen2.5:14b",   # ollama list 로 확인 후 변경
    "temperature": 0.3,
    "top_p": 0.95,
    "repeat_penalty": 1.2,
...
def get_qdrant():
    ...
    if _qdrant_instance is None:
        ...
        _qdrant_instance = QdrantClient(path="qdrant_data_qwen")
...
QDRANT_DB_PATH = "qdrant_data_qwen"  
