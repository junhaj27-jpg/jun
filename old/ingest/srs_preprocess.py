...
SRS_DATA_PIPELINE_DIR = DATA_PIPELINE_DIR / "SRS" / "data_pipeline"
if str(SRS_DATA_PIPELINE_DIR) not in sys.path:
    sys.path.insert(0, str(SRS_DATA_PIPELINE_DIR))
...
def main():
    ...
    TARGET_DIRS, SUPPORTED_EXTENSIONS = [
        "./data/requirement_reference/강제 규정",
        "./data/requirement_reference/기술",
        "./data/requirement_reference/요구사항 가이드",
        "./data/terminology/용어사전",
        "./data/requirement_examples/GDS",
    ], [".pdf", ".docx", ".txt", ".md"]
